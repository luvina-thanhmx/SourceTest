...
class JobDsl implements JobDSLService {
	...
	public boolean removeInstances(File instfile) {
		println "=======================removeInstances=========================="
		println "22222222222222222222222222222222 " + mapInstFileListInsts
		def instfilename = instfile.getName()
		...
		println "3333333333333333333333333333333333 " + mapInstFileListInsts
		return true
	}
