...
public class JobDsl_ProcessJob_Test {
	...
	public void processJob_01()throws Exception {
		...
		jobDslInst.lstTriggerWaitJob.add(tmpMap)
		...
		println "setup============================================" + jobDslInst.lstTriggerWaitJob
		sleep(2000)
		// run test processJob
		boolean ret = jobDslInst.processJob(new File(path + "/src/resources/jobdsl/processJob/testJob_01.job"))
		println "===============mapJobJobFile " + jobDslInst.mapJobJobFile		
