...
var BoolCellFormatter = function(row, cell, value, columnDef, dataContext) {
    return value ? "<img src='./img/instances-detail/tick.png'>" : "";
};

var TaskNameFormatter = function(row, cell, value, columnDef, dataContext) {
    // todo:  html encode
    var spacer = "<span style='display:inline-block;height:1px;width:" + (2 + 15 * dataContext["indent"]) + "px'></span>";
    return spacer + " <img src='./img/instances-detail/expand.gif'>&nbsp;" + value;
};
...
var ResourcesFormatter = function(row, cell, value, columnDef, dataContext) {
	...
	if (columnDef.width < 50)
		return (resources.length > 1 ? "<center><img src='./img/instances-detail/user_identity_plus.gif' " : "<center><img src='./img/instances-detail/user_identity.gif' ") +
...
var StarFormatter = function(row, cell, value, columnDef, dataContext) {
    return (value) ? "<img src='./img/instances-detail/bullet_star.png' align='absmiddle'>" : "";
};
...
var DateCellEditor = function($container, columnDef, value, dataContext) {
    ...
    this.init = function() {
        ...
        $input.datepicker({
            ...
            buttonImage: "./img/instances-detail/calendar.gif"
        });
...
var StarCellEditor = function($container, columnDef, value, dataContext) {
    ...
    this.init = function() {
        $input = $("<IMG src='./img/instances-detail/bullet_star.png' align=absmiddle tabIndex=0 title='Click or press Space to toggle' />");
