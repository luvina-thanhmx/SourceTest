...
(function() {
	function GridNicColumnPicker(columns,grid)
	{
		var $menu;
		...
		function init() {
			...
			$menu = $("<span class='gridnic-columnpicker' style='display:none;position:absolute;z-index:20;' />").appendTo(document.body);
	...
	// GridNic.Controls.ColumnPicker
	$.extend(true, window, { GridNic: { Controls: { ColumnPicker: GridNicColumnPicker }}});
})();
